                    ...
                    <div className='grid grid-cols-2 gap-6'>
                        ...
                        <div className='flex items-center justify-center'>
                            <div className='space-y-4'>
                                ...
                                <Link to={`/project/${1}`}> <button className='cmn-btn-one'>Case Study</button></Link>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className='grid grid-cols-2 gap-6'>
                    ...
                    <div className='flex items-center justify-center'>
                        <div className='space-y-4'>
                            ...
                            <p className='!mb-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia nam atque aliquid quae laboriosam cupiditate molestias dicta impedit! Nobis in doloremque illo esse ullam vero sint quam amet repudiandae praesentium.</p>
                            <Link to={`/project/${2}`}> <button className='cmn-btn-one'>Case Study</button></Link>
                        </div>
                    </div>
                </div>
                ...
                <div className='grid grid-cols-2 gap-6'>
                    ...
                    <div className='flex items-center justify-center'>
                        <div className='space-y-4'>
                            ...
                            <p className='!mb-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia nam atque aliquid quae laboriosam cupiditate molestias dicta impedit! Nobis in doloremque illo esse ullam vero sint quam amet repudiandae praesentium.</p>
                            <Link to={`/project/${3}`}> <button className='cmn-btn-one'>Case Study</button></Link>
                        </div>
                    </div>
                </div>
            </div>
